 <!-- Main navbar -->
        <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-header">
                ...
                <img src="/static/assets/images/logo/1.png" alt="VNS">
                </a>
            ...
            <div class="navbar-collapse collapse" id="navbar-mobile">
                <ul class="nav navbar-nav">
                    <li>
                        <a title="Chuyên viên CSKH:VNS" href="">
                        Chuyên viên CSKH: <span class="text-bold">VNS</span> <i class="icon-phone ml-10 text-orange-300"></i> 0123456789 <i class="icon-envelop ml-10 text-green-300"></i> VNS@gmail.com
                        </a>
                    </li>
                </ul>
