                ...
                <div class="row no-mrg">
                                ...
                                <div class="row extra-mrg job-list brows-employer-list mrg-bot-10">
                                    <div class="col-sm-9">
                                        <div class="sidebar-widget-title mrg-bot-15">
                                            ...
                                            <h4>Có <b style="color: red">{{count($count_vieclam)}}</b> việc làm được tìm thấy </h4>
                                        </div>
                    ...
                    <div class="col-sm-12 mrg-top-20">
                        <a rel="nofollow" href="" target="_blank" >
                            <picture>
                                <img src="/static/assets/images/banner/4.jpg" width="100%" class="img-responsive hidden-xs lazy" alt="VNS"> 
                            </picture>
                        </a>
                    </div>
                </div>
