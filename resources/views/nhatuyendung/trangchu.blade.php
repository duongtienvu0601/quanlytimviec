            ...
            <div class="container">
                <div class="row v-center">
                    <div class="col-xs-12 col-md-5 header-text">
                        ...
                        <p><strong>VNS</strong> giúp bạn tìm được nhân sự phù hợp thật nhanh và hiệu quả. Hệ thống <strong>VNS</strong> tìm kiếm thông minh và chủ động gợi ý các ứng viên thích hợp, đồng thời tự động hoá quy trình quản lý ứng viên. </p>
                                    ...
                                    <div class="v-center">
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="caption-desc" data-animation="animated fadeInUp">
                                                <p>Từ việc phân tích & thấu hiểu profile doanh nghiệp và từng VNS đăng tuyển, VNS chủ động tìm kiếm & mang về cho bạn các ứng viên phù hợp nhất. Mỗi khi có ứng viên tiềm năng gia nhập hệ thống.</p>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="caption-desc" data-animation="animated fadeInUp">
                                                <p>Cho phép bạn quản lý toàn bộ các VNS đăng tuyển và ứng viên rất chi tiết và hiệu quả. <br> Tự động hoá việc chăm sóc ứng viên, từ việc gửi các thông báo kết quả, cho đến việc yêu cầu thêm thông tin hồ sơ.</p>
                                            </div>
                                            <div class="caption-button" data-animation="animated fadeInUp"></div>
                                        </div>
                                        <div class="col-xs-12 col-md-3">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="caption-desc" data-animation="animated fadeInUp">
                                                <p> Thương hiệu doanh nghiệp bạn được xây dựng qua profile ấn tượng trên VNS. <br> Hàng nghìn ứng viên biết đến môi trường làm việc, văn hoá, cũng như business của doanh nghiệp bạn.</p>
                                            </div>
                                            <div class="caption-button" data-animation="animated fadeInUp"></div>
                                        </div>
                                    </div>
