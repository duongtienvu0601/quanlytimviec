                    ...
                    <div class="col-sm-12">
                        <div class="clearfix">
                            <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <li class="active"><span class="text-muted">Việc làm thực tập sinh</span></li>
                            </ol>
                                ...
                                <div class="row extra-mrg job-list brows-employer-list mrg-bot-10">
                                    <div class="col-sm-9">
                                        <div class="sidebar-widget-title mrg-bot-15">
                                            ...
                                            <h4>Có <b style="color: red">{{count($count_thuctapsinh)}}</b> việc làm được tìm thấy</h4>
                                        </div>
                                        @if($thuctapsinh != null)
                                            @foreach($thuctapsinh as $vl)
                                            ...
                                            <div class="sidebar-widget padd-top-0 padd-bot-0 mrg-top-25">
                                                ...
                                                <ul class="sidebar-list expandible colorgb-job-filter colorgb-job-type">
                                                    ...
                                                    <li class="thuc-tap-sinh ">
                                                        <a title="Việc làm thực tập sinh" href="{{route('vieclamthuctapsinh')}}" style="color: red">
