                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title">
                                        ...
                                        <b>Danh sách việc làm đã ứng tuyển
                                        </b>
                                ...
                                <table class="table table-bordered">
                                  ...
                                  <tbody>
                                    @foreach($daungtuyen as $ut)
                                    <tr>                                    
                                        <th scope="row">{{$stt++}}</th>
                                        <td><a href="{{route('chitietvieclam',$ut->id_vl)}}">{{$ut->vieclam->ten_vl}}</a></td>
                                        <td><a href="{{route('chitietcongty',$ut->id_ntd)}}">{{$ut->cti->ten_cty}}</td>
                                        <td>{{$ut->created_at}}</td>
                                        <td>
                                            @if($ut->trangthai == 0)
                                        ...
                                        <td>
                                            <form action="{{route('XoaViecUngTuyen',$ut->id)}}" method="post">
                                                @csrf
