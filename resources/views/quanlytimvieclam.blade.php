...
@section('content')
        <section class="intro-banner">
            <div class="colorgb-banner" style="height:380px;">
                        ...
                        <div class="wrap">
                            <div class="container">
                                <picture class="left-img">
                                    ...
                                    <img src="/static/assets/images/banner/1.png" alt=""> 
                                </picture>
                                <picture class="right-img">
                                    ...
                                    <img src="/static/assets/images/banner/3.png" alt=""> 
                                </picture>
                            ...
                            <div class="item">
                                ...
                                <div class="item-click">
                                    <article class="standard">
                                        ...
                                        <span class="tg-themetag tg-featuretag hot">Mới nhất</span>
                                    </article>
                                </div>
                                @endforeach
                            </div>
