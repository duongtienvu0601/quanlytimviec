        ...
        <div class="page-container login-container">
            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    <form action="{{route('dangnhapNTD')}}" method="post">
                        @csrf
                        ...
                        <div class="panel panel-body login-form">
                            ...
                            <a href="{{route('dangkyNTD')}}" class="text-size-base btn btn-default btn-block content-group text-uppercase">Đăng ký thông tin nhà tuyển dụng</a>
                        </div>
                    </form>
                </div>
                <!-- /main content -->
