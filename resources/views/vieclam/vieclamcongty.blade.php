...
<html lang="vi-VN">
    <head>
        <title>Tuyển dụng, tìm việc làm trong tháng 12/2020 </title>
                        ...
                        <div class="clearfix">
                            <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
                                    <a href="{{route('quanlytimvieclam.com')}}" itemtype="https://schema.org/Thing" itemprop="item"> <span itemprop="name">VNS</span> </a> 
                                    <meta itemprop="position" content="1">
                                </li>
                                <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
                                    <a href="{{route('vieclam')}}" itemtype="https://schema.org/Thing" itemprop="item"> <span itemprop="name">Việc làm</span> </a> 
                                    <meta itemprop="position" content="2">
                                </li>
                                <li class="active"><span class="text-muted">Việc làm công ty</span></li>
                                <li class="active"><span class="text-muted"><a href="{{route('chitietcongty',$congty->id)}}">{{$congty->ten_cty}}</a></span></li>
                            </ol>
                                ...
                                <div class="row extra-mrg job-list brows-employer-list mrg-bot-10">
                                    <div class="col-sm-9">
                                        <div class="sidebar-widget-title mrg-bot-15">
                                            ...
                                            <h4>Có <b style="color: red">{{count($count_vlcty)}}</b> việc làm được tìm thấy</h4>
                                        </div>
                                        @if($vlcty != null)
                                            @foreach($vlcty as $vl)
                                        ...
                                        <div class="blog-sidebar">
                                            <div class="sidebar-widget padd-top-0 padd-bot-0">
                                                ...
                                                <ul class="sidebar-list expandible colorgb-job-filter">
                                                    <li class="t1d ">
                                                        <a title="Việc làm hôm nay" href="{{route('vieclamhomnay')}}">
